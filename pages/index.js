...
export default function index() {
    return <>
    <Head>
        <title>Edison Harris | Full Stack Engineer</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta name="description" content="Edison's portfolio. I solve problems using code (Mostly web). Engineer from Somewhere and everywhere."/>
